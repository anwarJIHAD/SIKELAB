 ...
 */
public class UpPengajuanA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String hargaTot=request.getParameter("total_harga");
           
           
         Pengajuan b = new Pengajuan();
            b.setId_Pengajuan(id_pengajuan);
            b.setNama_Barang(nama_barang);
            b.setJumlah(parseInt(jumlah));
            b.setHarga(parseInt(harga));
            b.setTotal_Harga(parseInt(hargaTot));
            
            PengajuanM editPengajuan = new PengajuanM();
            
            //out.print(editBarang.update(b));
            if(editPengajuan.update1(b)==true){
            ...
            response.sendRedirect("kalab/pengajuan.jsp?message=" + URLEncoder.encode(pesan, "UTF-8"));
        }finally{
            out.close();
        }
    }
