 ...
 * @author LENOVO
 */
public class edit_anggaran extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (con != null){
                    if (id != null && id_periode != null && nama != null && jumlah_anggaran != null ){
                        PreparedStatement pst = con.prepareStatement("UPDATE anggaran SET id_anggaran = ?, id_periode = ?, nama_anggaran = ?, jumlah_anggaran = ? WHERE id_anggaran = '"+id+"'");
                        pst.setString(1, id);
                        pst.setString(2, id_periode);
                        pst.setString(3, nama);
                        pst.setString(4, jumlah_anggaran);
                        pst.executeUpdate();
